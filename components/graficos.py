...
def plotar_graficos(dados_pontos, populacao_prevista):
    # Gráfico 1: População atual por ponto de coleta (transformado em gráfico de linha)
    ...
    # Gráfico 2: População prevista com base na previsão do tempo
    ...
    # Gráfico 3: Comparativo da infestação atual vs. pico previsto
